...
function AccordionItemConstructionSystem(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await DAOSettings.updateSettings({ constructionSystem: { content: content.value } });
...
export default AccordionItemConstructionSystem;

...
function AccordionItemCategories(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await DAOSettings.updateSettings({ categories: { perPage: perPage.value } });
      ...
      <AccordionPanel pb={4}>
        <form noValidate onSubmit={handleSubmit}>
          <FormControl mt={4} isInvalid={errors.perPage}>
            <FormLabel>Cantidad de casas a mostrar por pagina.</FormLabel>
            <Input
              type="text"
              id="perPage"
              name="perPage"
              ...
              placeholder="Cantidad de casas a mostrar."
              variant="flushed"
            />
...
export default AccordionItemCategories;
